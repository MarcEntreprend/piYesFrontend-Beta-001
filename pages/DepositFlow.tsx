          ...
          <div className="flex-1 animate-in slide-in-from-right duration-300 flex flex-col">
            <div className="flex-1">
              <h2 className="text-2xl font-bold mb-8 theme-text-main">
                {t("deposit.amount_q", { currency: t("currency.name_plural") })}
              </h2>
              <div className="flex items-center border-b-2 theme-border pb-2 mb-10 focus-within:border-(--primary-color) transition-all">
              ...
              <div className="space-y-3">
                {filteredAgents.map((agent) => (
                  ...
                  >
                    ...
                    >
                      {loading && selectedAgent?.id === agent.id ? (
