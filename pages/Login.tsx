...
import { Smartphone, ShieldCheck, ChevronRight, ArrowLeft, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen theme-card-bg flex flex-col px-8 pt-12 animate-in fade-in duration-500">
      ...
      <div className="mb-10 flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <h1 className="theme-primary-text text-3xl font-black italic tracking-tighter">piYès</h1>
        </div>
      ...
      {step === 1 && (
        <div className="mb-10 space-y-2 animate-in slide-in-from-top duration-500">
          <h2 className="text-[28px] font-black theme-text-main leading-tight tracking-tight">
            ...
            <span className="theme-primary-text">Simplement</span> et en toute sécurité.
          </h2>
          ...
          {step === 1 ? (
            <div className="space-y-2">
              <input
                ...
                className={`w-full text-lg border-b-2 ${error ? 'border-red-500' : 'theme-border focus:border-[var(--primary-color)]'} py-3 outline-none transition-colors bg-transparent theme-text-main font-bold`}
                required
              />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 p-3 theme-bubble-bg rounded-2xl border theme-border">
                <div className="w-8 h-8 theme-primary-bg rounded-full flex items-center justify-center text-white text-xs font-black">
                  {identifier.includes('@') ? identifier[0].toUpperCase() : '📱'}
                </div>
                <p className="text-sm font-bold theme-text-main truncate">{identifier}</p>
              </div>
              <div className="space-y-2">
                <input
                  autoFocus
                  ...
                  className="w-full text-lg border-b-2 theme-border focus:border-[var(--primary-color)] py-3 outline-none transition-colors bg-transparent theme-text-main font-bold"
                  required
                />
                <p className="text-[10px] theme-text-secondary font-bold uppercase tracking-widest">{t('auth.signup_pass_hint')}</p>
              </div>
                <Button
                  type="button"
                  variant="text"
        ...
        {step === 1 && (
          <div className="mt-8 space-y-5">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[10px] font-black theme-text-secondary uppercase tracking-[0.2em]">ou se connecter avec</span>
              <div className="h-px flex-1 theme-border border-t" />
            </div>
