    ...
    <div className="flex items-center justify-between p-4 theme-bubble-bg rounded-2xl border theme-border shadow-sm active:scale-[0.98] transition-transform">
      <div className="flex items-center gap-4">
        ...
        <div className="text-left">
          ...
          <p className="text-[10px] theme-text-secondary font-medium tracking-tight">
            {sublabel}
          </p>
        </div>
      </div>
      ...
      >
        <div
          className={`w-4 h-4 bg-white rounded-full shadow-md transition-transform duration-300 ${enabled ? "translate-x-6" : "translate-x-0"}`}
        ></div>
      </button>
    </div>
  );
    ...
    <div className="theme-card-bg min-h-screen flex flex-col animate-in slide-in-from-right duration-500 pb-32">
      <PageHeader
        ...
        rightElement={
          syncing && (
            <RefreshCw
              size={16}
              className="theme-primary-text animate-spin mr-2"
            />
          )
        }
      ...
      <div className="p-6 space-y-8">
        ...
        <section
          ...
          className="space-y-4 transition-all duration-500 p-2 rounded-2xl"
        >
          <h3 className="text-[11px] font-black theme-text-secondary uppercase tracking-[0.2em] px-1 pt-4">
            {t("notif_settings.categories")}
          </h3>
          <div className="space-y-3">
            <NotificationItem
              id="security"
        ...
        <div className="p-5 theme-bubble-bg rounded-3xl border border-dashed border-(--primary-color) opacity-70 mt-8">
