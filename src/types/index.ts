...
export interface Receipt {
  ...
  description?: string;
  sender?: { name: string; account_number?: string; masked_account?: string; idNumber?: string; bank?: string };
  receiver?: { name: string; account_number?: string; masked_account?: string; idNumber?: string; bank?: string };
...
export interface SyncResponse {
  ...
  serverTime: string;
  config: { maintenance: boolean; updateRequired: boolean };
}
...
export interface Ad {
  ...
  rating: number;
  date: string;
  seller: { id: string; name: string; avatar: string; phone?: string; acceptsPiyes: boolean };
...
export interface Conversation {
  ...
  adImage: string;
  role: "buyer" | "seller";
  counterparty: { id: string; name: string; avatar: string; isVerified?: boolean };
  messages: Message[];
  lastMessage: string;
  lastTime: string;
  unreadCount: number;
...
export interface Card {
  ...
  limit: number;
  isFrozen: boolean;
  settings: { onlinePayments: boolean; international: boolean; contactless: boolean };
}
