...
export const translations = {
  fr: {
    ...
    auth: {
      ...
      signup_apple: "Apple",
      signup_pass_hint: "Min. 6 caractères",
  ...
  ht: {
    ...
    auth: {
      ...
      signup_confirm_pass_label: "Konfime modpas la",
      ...
      login_error_invalid_credentials: "Nou pa jwenn okenn kont ak enfòmasyon sa yo. Tcheke imèl oswa nimewo telefòn ou.",
    ...
    contacts: {
      ...
      delete_confirm: "Ou vle siprime {{name}} tout bon ?",
      detail: {
        relation: "Relasyon",
  ...
  en: {
    ...
    auth: {
      ...
      signup_google: "Google",
      signup_apple: "Apple",
      signup_pass_hint: "Min. 6 characters",
