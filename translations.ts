...
export const translations = {
  fr: {
    ...
    auth: {
      ...
      login_error_timeout: "Le serveur met trop de temps à répondre. Réessayez.",
      login_error_backend_down: "Service indisponible. Veuillez réessayer plus tard.",
      login_error_cors: "Problème de connexion sécurisée. Contactez le support.",
    ...
    profile_hub: {
      ...
      modify_photo_title: "Modifier la photo",
      camera_option: "Appareil photo",
      camera_desc: "Prendre une photo maintenant",
      gallery_option: "Galerie",
      gallery_desc: "Choisir une image depuis vos albums",
      crop_existing_option: "Recadrer la photo actuelle",
      crop_existing_desc: "Ajuster le cadrage de votre photo",
      delete_photo_option: "Supprimer la photo",
      delete_photo_desc: "Revenir aux initiales",
      photo_deleted: "Photo supprimée",
      unsaved_changes_title: "Modifications non sauvegardées",
      unsaved_changes_message: "Vous avez des modifications non sauvegardées. Voulez-vous vraiment quitter sans sauvegarder ?",
      leave_without_saving: "Quitter sans sauvegarder",
      verify_box: {
    ...
    notifications: {
      ...
      selected_count_singular: "notification",
      selected_count_plural: "notifications",
  ...
  ht: {
    ...
    auth: {
      ...
      login_error_timeout: "Sèvè a pran twòp tan pou reponn. Eseye ankò.",
      login_error_backend_down: "Sèvis la disponib pou kounye a. Tanpri eseye ankò pita.",
      login_error_cors: "Pwoblèm koneksyon sekirize. Kontakte sipò a.",
    ...
    dashboard: {
      ...
      view_history: "Istorik tranzaksyon",
      all_banks: "Tout",
    ...
    profile_hub: {
      ...
      modify_photo_title: "Chanje foto a",
      camera_option: "Aparèy foto",
      camera_desc: "Pran yon foto kounye a",
      gallery_option: "Galeri",
      gallery_desc: "Chwazi yon imaj nan albòm ou yo",
      crop_existing_option: "Rekadre foto aktyèl la",
      crop_existing_desc: "Ajuste kadraj foto ou a",
      delete_photo_option: "Efase foto a",
      delete_photo_desc: "Retounen nan inisyal yo",
      photo_deleted: "Foto efase",
      unsaved_changes_title: "Chanjo ki pa anrejistre",
      unsaved_changes_message: "Ou gen chanjo ki poko anrejistre. Èske ou vle kite san w pa anrejistre ?",
      leave_without_saving: "Kite san anrejistre",
      verify_box: {
    ...
    notifications: {
      ...
      selected_count: "{{count}} seleksyon",
      select_all: "Chwazi tout",
      selected_count_singular: "notifikasyon",
      selected_count_plural: "notifikasyon",
      clear_selected: "Efase seleksyon an",
      errors: {
  ...
  en: {
    ...
    auth: {
      ...
      login_error_timeout: "The server is taking too long to respond. Please try again.",
      login_error_backend_down: "Service unavailable. Please try again later.",
      login_error_cors: "Secure connection issue. Please contact support.",
    ...
    profile_hub: {
      ...
      modify_photo_title: "Edit photo",
      camera_option: "Camera",
      camera_desc: "Take a photo now",
      gallery_option: "Gallery",
      gallery_desc: "Choose an image from your albums",
      crop_existing_option: "Crop current photo",
      crop_existing_desc: "Adjust the framing of your photo",
      delete_photo_option: "Delete photo",
      delete_photo_desc: "Revert to initials",
      photo_deleted: "Photo deleted",
      unsaved_changes_title: "Unsaved changes",
      unsaved_changes_message: "You have unsaved changes. Do you really want to leave without saving?",
